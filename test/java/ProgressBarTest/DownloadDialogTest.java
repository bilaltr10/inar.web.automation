...
public class DownloadDialogTest extends Hooks {
    ...
    public void downloadDialogTest() {
        ...
        Assertions.assertEquals(expected, actual, "Clicked on 'start download bar" +
                " so download should start'");
        ...
        Assertions.assertEquals(isDownloadStopped, actualDownload, "Clicked on cancel so download must stop and " +
