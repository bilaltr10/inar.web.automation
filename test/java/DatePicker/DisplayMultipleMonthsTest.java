...
public class DisplayMultipleMonthsTest extends Hooks {
    ...
    public void displayMultipleMonthsTest() {
        ...
        Assertions.assertEquals(isVisibleExpected, isVisibleActual, "When clicked on date " +
                "item calender should be visible");
        ...
        Assertions.assertEquals(expectedMont,actualMonth,"Clicked on prev button calender should start from September");
        ...
        Assertions.assertEquals(expectedMonthAfterClickedNext,actualMonthAfterClickedNext,"Clicked two times next button so month " +
                "on the right side of calender should be January");


        //click on today button and verify that calender start from chosen month (Here is answer is October)
        ...
        Assertions.assertEquals(expectedMonthAfterClickedToday,actualMonthAfterClickedToday, "click on today button and  calender sholud start" +
        ...
        Assertions.assertEquals(isCalenderExpectedVisible,isCalenderActualVisible,"Clicked on done button" +
                "so calender should disappear");
