...
public class ToolBar extends BasePage {
	...
	public void setZoom(String keys) {
		Select select = new Select(allTheToolsAtTop
			.findElement(By.cssSelector(" .form-select.me-2.bg-primary.text-fifth.fs-4:nth-child(1)")));
		select.selectByVisibleText(keys);
		// allTheToolsAtTop.findElement(By.cssSelector("
		// .form-select.me-2.bg-primary.text-fifth.fs-4:nth-child(1)")).sendKeys(keys);
	}

	public void setHighlightColor(String colorAsHighlight) {
		allTheToolsAtTop.findElement(By.cssSelector(" " + ".form-select.me-2.bg-primary.text-fifth.fs-4:nth-child(2)"))
			.sendKeys(colorAsHighlight);
	}

	public void setColorOfText(String colorOfText) {
		allTheToolsAtTop.findElement(By.cssSelector(" " + ".form-select.me-2.bg-primary.text-fifth.fs-4:nth-child(3)"))
			.sendKeys(colorOfText);
	}
